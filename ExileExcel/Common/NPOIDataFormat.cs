...
{
    public enum NPOIDataFormatEnum
    {
        General = 0, //0 General
        NumberInteger, //1 0
    ...
    public static class NPOIDataFormat
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="dataFormat">DataFormat create by workbook</param>
        ...
        public static string Conver2ExcelDataFormat(Type type)
        {
            ...
            if (type == typeof (int))
            {
                ...
                formatString = BuiltinFormats.GetBuiltinFormat((int) NPOIDataFormatEnum.NumberInteger);
            }
            else if (type == typeof (string))
            {
                //retVal=(int)NPOIDataFormatEnum.Text;
                formatString = BuiltinFormats.GetBuiltinFormat((int) NPOIDataFormatEnum.Text);
            }
            else if (type==typeof(Single) ||type == typeof (float) || type == typeof (double))
            {
                switch (DefalultDecimalPlace)
                {
                    ...
                    case 2:
                        ...
                        formatString = BuiltinFormats.GetBuiltinFormat((int) NPOIDataFormatEnum.Number2DecimalPlace);
                        break;
                    default:
                    {
